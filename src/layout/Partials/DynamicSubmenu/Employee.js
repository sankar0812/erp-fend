import { AiFillMoneyCollect, AiOutlineAccountBook, AiOutlineDashboard, AiOutlineFundView, AiOutlineTags } from "react-icons/ai";
...
export const EmployeeItems = (collapsed, Employeeid) => {
    ...
    let items = [
        ...
        getItem(<MenuText>{collapsed ? null : 'HRM'}</MenuText>, 'HRM', null,
            [
                // getItem('Complaint', 'sub1', <BsFillClipboard2DataFill />, [
                    // ]),
...
export const employeeKeys = ['sub0','sub1', 'sub2', 'sub3', 'sub4'];