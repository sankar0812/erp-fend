...
import { getClientProfile, viewErpClientprofile } from '../../ErpClientSlice'
...
const ErpClientProfile = () => {

    const dispatch = useDispatch()
    const ViewClientDetails = useSelector(viewErpClientprofile)
                                ...
                                <CustomRow>
                                    ...
                                    <Col span={24} md={11}  >
                                        <BioDataHolder>
                                            ...
                                            <h1>Name&nbsp;:&nbsp;{ViewClientDetails[0]?.clientName}</h1>
                                            <h1>Ph.No&nbsp;:&nbsp;{ViewClientDetails[0]?.mobileNumber}</h1>
                                            <h1>Email&nbsp;:&nbsp;{ViewClientDetails[0]?.email}</h1>
                                            <h1>Gender&nbsp;:&nbsp;{ViewClientDetails[0]?.gender}</h1> */}
                                    ...
                                    <Col span={24} md={9}  >
                                        <BioDataHolder>
                                            ...
                                            {ViewClientDetails[0]?.address},&nbsp;
                                            {ViewClientDetails[0]?.country} */}
...
export default ErpClientProfile