...
import { getquotation, viewquotation } from '../../quotationSlice';
...
export const ViewPrint = ({ businessProfile, record }) => {
    ...
    const QuotationRecord = Allquotation.find((item) => item.quotationId === record?.record);
        ...
        return (
            <PrintWrapper>
                <PrintHolder ref={componentRef}>
                    <h1 style={{ fontSize: '22px', color: '#fe7900', textAlign: 'center' }}>Quotation</h1>
                    <Flex spacebetween="true" aligncenter={'true'} style={{paddingBottom: '10px'}} >
                        ...
                        <div >
                            <Flex aligncenter={'true'}  >
                                <p style={{ paddingBottom: '15px' }}>Quotation No :</p>
                                <p style={{ fontWeight: 'bolder', fontSize: '15px', color: '#000', paddingBottom: '15px' }}>{recordData?.quotationId}</p>
                            </Flex>
                            <Flex>
                                <p>Date :</p>
                    ...
                    <div style={{ margin: '10px 0px' }}>
                        <CustomRow space={[12, 12]}>
                            <Col span={24} md={12}   >
                                <div style={{ backgroundColor: '#f3f8f9', display: 'flex', flexDirection: 'column', padding: '10px' }}>
                    ...
                    <BillTable>
                        <table>
                            ...
                            <tbody>
                                {
                                    recordData?.quotationList?.map((item, index) => (
                                        <tr key={item.id}>
                                            <td>{index + 1}</td>
                                            <td>{item?.itemName}</td>
