...
import { getMaintenance, getMaintianInvoices } from '../invoiceSlice';
...
export const ViewPrint = ({ businessProfile, record }) => {
    // console.log(record,'recordrecordjj');
    ...
    console.log(AllMaintenanceViews, 'AllMaintenanceViews');
    console.log(recordData, 'invrec');
    ...
    const Maintenance = useMemo(() => AllMaintenanceViews?.find((item) => item.maintenanceInvoiceId === record?.record), [AllMaintenanceViews, record])
    console.log(Maintenance, 'QQQMaintenance');
    ...
    console.log(profdetails, 'profdetails');
            ...
            <PrintWrapper>
                <PrintHolder ref={componentRef}>
                        ...
                        <CustomRow space={[12, 12]}>
                            ...
                            <Col span={24} md={12} style={{ backgroundColor: '#f4433624' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', padding: '10px' }}>
                                    ...
                                    <p style={{ marginBottom: "5px" }}>{record?.clientAddress},{record?.clientState},{record?.country},{record?.clientZipcode}</p>
                            ...
                            <tbody>
                                {
                                    recordData?.invoiceList?.map((item, index) => (
                                        <tr key={item.id}>
                                            ...
                                            <td>{item?.price}</td>
                                            <td>{item?.taxIncludePrice === 0 ? '-' : item?.taxIncludePrice}</td>
                                            <td>{item?.amount}</td>
                                        </tr>
                                    ))
                                }
                    ...
                    <CustomRow space={[12, 12]}>
                        <Col span={24} md={24}>
                            {/* <Flex gap={'5px'} spacebetween="true" >
                                <h1 style={{ color: '#7e2ee1', fontSize: '16px', fontWeight: 'bolder', margin: '10px 0px' }}>{recordData?.title} :</h1>
                            </Flex> */}
                        </Col>
                        <Col span={24} md={24}>
                            {/* <Flex >
