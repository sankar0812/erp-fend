...
import { PrintHolder, PrintSubTitle, PrintTableFooterHolders, PrintTitle, PrintViewValue, PrintWrapper, SignImageHolder } from '../../../../../../components/Form/Styled';
...
export const ReportServerViewPrint = ({ record }) => {
        ...
        return (
            <PrintWrapper>
                <PrintHolder ref={componentRef}>
                    <h1 style={{ fontSize: '22px', color: '#fe7900', textAlign: 'center' }}>Server Maintenance</h1>
                    ...
                    <Flex spacebetween="true" aligncenter={'true'} style={{paddingBottom: '10px'}} >
                        ...
                        <div >
                            <Flex aligncenter={'true'}  >
                                <p style={{ paddingBottom: '15px' }}>Server Maintain No :</p>
                                <p style={{ fontWeight: 'bolder', fontSize: '15px', color: '#000', paddingBottom: '15px' }}>{recordData?.serverMaintenanceId}</p>
                            </Flex>
                            <Flex>
                                <p>Date :</p>
                                <p style={{ fontWeight: 'bolder', fontSize: '15px', color: '#000' }}>{recordData?.date}</p>
                            </Flex>
                        </div>
                    </Flex>
                    ...
                    <div style={{ margin: '10px 0px' }}>
                        <CustomRow>
                            <Col span={24} md={24}>
                                <div style={{ backgroundColor: 'rgb(231 222 143 / 64%)', display: 'flex', flexDirection: 'column', padding: '10px' }}>
                            ...
                            {/* <Col span={24} md={12} style={{ backgroundColor: '#f3f8f9' }}>
                    ...
                    <BillTable>
                        <table>
                            ...
                            <tbody>
                                        <tr>
                                        <td>1.</td>
                                            <td>{recordData?.serverTypeName}</td>
                    ...
                    <CustomRow space={[12, 12]}>
                        {/* <Col span={24} md={24}>
                            <Flex gap={'5px'} spacebetween="true"={'true'} >
                                    ...
                                    {TotalTermDAta?.map((item, index) => {
                                        return (
                                            <>
                                                <Col span={24}>
                                                    <Flex>
                                                        <p style={{ marginBottom: '5px' }}>{index + 1})&nbsp;{item.termsAndCondition}</p>
