...
import { ReportServerViewPrint } from "./ReportServerViewPrint";

const ViewServermaintainReportTable = () => {
  ...
  const handleprintview = (record) => {
    setModalTitle("Server Maintenance Print");
    setModalContent(<ReportServerViewPrint record={record} />);
    showModal();
  };
 ...
 //================= Date Search filter Server Maintenance report  fn============
  ...
  const DateSearch = (values) => {
    request
      .post(`${APIURLS.POST_SERVER_MAINTAIN_REPORTS}`, values)
  ...
  const columns = [
    ...
    },
    {
      ...
      onFilter: (value, record) => {
        return (
          String(record.serverTypeName)
            .toLowerCase()
            .includes(value.toLowerCase()) ||
          String(record.serverTypeName).includes(value.toUpperCase())
        );
      },
    },
    {
      title: "Server Maintenance No",
      dataIndex: "serverMaintenanceId",
    },
    {
      title: "Date",
      dataIndex: "date",
  ...
  return (
    <Fragment>
        <CustomPageTitle Heading={"Server Maintenance Report"} />
        <br />
        <Form
          form={form}
          labelCol={{
...
export default ViewServermaintainReportTable;
