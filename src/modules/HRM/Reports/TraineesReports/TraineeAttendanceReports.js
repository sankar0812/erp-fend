...
import { getDepartmentRole, selectAllDepartmentRole } from '../../Recruitments/RecruitmentSlice';
...
import { getTraineeDepartment, selectAllTraineeDepartment } from '../ReportsSlice';

export const TraineeAttendanceReports = () => {
  ...
  // console.log(countattendance, "data");
  ...
  const DateSearch = (values) => {
    request
      .post(`${APIURLS.POSTREPORTTRAINEEATTENDANCE}`, values)
  ...
  useEffect(() => {
    dispatch(getTraineeDepartment());
  }, []);

  const AllDepartmentRole = useSelector(selectAllTraineeDepartment);
  ...
  const handleDepartment = (e) => {
    ...
    form.setFieldsValue({ traineeId: null });
    ...
    //   label: value.userName,(value.traineeId),
  ...
  const handleInterviewChange = (value) => {
    form.setFieldsValue({ traineeId: value });
  };
                    ...
                    <CustomRow space={[24, 24]}>
                     ...
                     <Col span={24} md={24} lg={6}>
                      ...
                      <Col span={24} md={24} lg={4}>
                        ...
                        />
                        <CustomInput name={"traineeId"} display={"none"} />
                      </Col>
