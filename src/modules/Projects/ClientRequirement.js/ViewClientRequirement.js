...
import { ClientRequirementForm } from './ClientRequirementForm';

export const ViewClientRequirement = () => {
    ...
    const EditClientRequest = (record) => {
        setModalTitle("Client Requirement");
        setModalContent(
            //   <LeaveForm
            ...
            //     leaveRecord={record}
            //   />
            <ClientRequirementForm clientRecord={record} formname={"EditRequirementForm"} FormExternalCloseee={FormExternalClose} />
        );
        showModal();
    };
    ...
    return (
        <div>
            <CustomPageTitle Heading={"Client Requirement"} />
            <CustomRow
                space={[24, 24]}
