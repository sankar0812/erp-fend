...
export const AssiginingTask = ({ projectRecord, formReset, Close , GetTaskDetailsByRole}) => {
    ...
    <Fragment>
      ...
      >
        <CustomRow space={[12, 12]}>
          ...
          <Col span={24} md={12}>
            <CustomSelect options={projectStatus} tag label={'Project Status'} placeholder={'Status'} disabled={'true'}
              name={'projectStatus'} />
      ...
      <div style={{ margin: '20px' }}>
        <TaskForm SetDynamicTable={SetDynamicTable} SetDynamicEditTable={SetDynamicEditTable} projectRecord={projectRecord} formReset={formReset} />
      </div>
