...
export const ProjectDocsForm = ({ projectTypeRecord }) => {
        ...
        <Fragment>
            ...
            >
                <CustomRow space={[12, 12]}>
                    ...
                    <Col span={24} md={12}>
                        <CustomInput label={'Employee Name'} placeholder={'Employee Name'}
                            name={'features'} />

                    </Col>
                    <Col span={24} md={12}>
                        <CustomSelect options={[]} label={'Type of Project'} placeholder={'Type of Project'}
                            name={'duration'} />
                    </Col>
                    <Col span={24} md={12}>
                    ...
                    <Col span={24} md={12}>
                    <CustomInput label={'URL'} placeholder={'url'}
                            name={'duration'} />
                    </Col>
